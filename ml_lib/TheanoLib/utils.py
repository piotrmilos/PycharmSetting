...
# class TimeseriesObserver(object):
#     def __init__(self, channel_manager, channel_name, add_freq, fun=np.mean):
#         self.channel_manager = channel_manager
#         self.channel_name = channel_name
#         self.add_freq = add_freq
#         self.fun = fun
#
#     def notify_add(self, ts, v):
#         if ts.size() % self.add_freq == 0 and ts.size():
#             self.channel_manager.add_to_channel(self.channel_name, self.fun(ts.last_n(self.add_freq)))
