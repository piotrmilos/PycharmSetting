...
def create(conf):
    ...
    with tf.variable_scope(name):
        ...
        res = create_apply_fc(res, n_output=20, n_input=4, activation=tf.nn.relu, name='fc1',
        ...
        #                       weights_initializer=tf.truncated_normal_initializer(stddev=0.01))
        res = create_apply_fc(res, n_output=2, n_input=20, activation=None, name='fc4_actions', biases_initializer=None,
        ...
        train_out_dict = {'q': q_s_a, 'loss': loss}
